...
void draw_pause_overlay(const Game *p_game) {
    ...
    al_draw_text(p_game->font_pequena, al_map_rgb(200, 200, 200), SCREEN_W / 2, SCREEN_H / 2 + 120, ALLEGRO_ALIGN_CENTER, "'P' - CONTINUAR");
    al_draw_text(p_game->font_pequena, al_map_rgb(200, 200, 200), SCREEN_W / 2, SCREEN_H / 2 + 150, ALLEGRO_ALIGN_CENTER, "'ESC' - VOLTAR AO MENU");
